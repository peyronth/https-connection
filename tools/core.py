...
def verify_user(username, password):
    data="""{ 
        "thomas":"$2b$12$Xn/RLqIViY/95TG0dKvIuOKDqshBZZ5wWI0Q980lKMKlVdfCyBMVW",
        "eugene":"$2b$12$Xn/RLqIViY/95TG0dKvIuOkDqshBZZ5wWI0Q980lKMKlVdfCyBMVW"
    }"""
    ...
    if username in users:
        hash=users[username]
        return (check_password(password.encode("utf-8"),hash.encode("utf-8")))
    else:
        return False

#print(verify_user("eugene",""))
#print(verify_user("eugene",""))
#print(verify_user("eugene","120601"))
#print(verify_user("thomas","120601"))
#print(get_hashed_password("120601".encode("utf-8")))